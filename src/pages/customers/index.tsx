...
import { useCreateCustomerMutation, useGetAllCustomers } from "@/services/mutations/customer";
                    ...
                    <form onSubmit={handleSubmit(createCustomer)}>
                        <Stack mt={'1rem'} rowGap={".6rem"}>
                            ...
                            <Box>
                                <AppSelect
                                    ...
                                    options={[
                                        ...
                                        { label: 'Swimming lesson Course', value: 'swimmingLessonCourseCustomer' },
                                    ]}
                            ...
                            <Flex justifyContent={'center'} gap={5} mt={'2rem'}>
                                ...
                                <PrimaryBtn size={"lg"} width={'100%'} label="Add Customer" isLoading={isPending} type="submit" />
                            </Flex>
                        </Stack>
                    </form>
